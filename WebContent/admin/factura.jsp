...
<section id="factura">
	<%
		...
		if (cliente != null && request.getParameter("fid") != null){
			...
			if(cliente.getCuentaCorriente().getFacturas() != null && !cliente.getCuentaCorriente().getFacturas().isEmpty()){
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="<%=request.getContextPath()%>/admin/cuentacorriente.jsp">Cuenta Corriente</a></li>
	...
	<div class="d-flex justify-content-end">
		<a class="btn btn-primary" href="<%=request.getContextPath()%>/admin/cuentacorriente.jsp">Volver al Cuenta Corriente</a>
	</div>
	<%
		}}
	%>
