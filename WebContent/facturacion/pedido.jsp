...
<section id="factura">
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a
				href="<%=request.getContextPath()%>/facturacion/index.jsp">Pedidos a Facturar</a></li>
	...
	<div class="alert alert-success alert-dismissible fade show" role="alert">
		<span class="alert-message">El pedido #<%=pedido.getId()%> ha sido facturado correctamente.</span>
	...
	<div class="d-flex justify-content-end">
		<a class="btn btn-secondary mr-3"
			href="<%=request.getContextPath()%>/facturacion/index.jsp">Volver al
			listado</a>
		<%
			if (pedido.getEstado() == EstadoPedidoDTO.A_FACTURAR) {
		%>
		<a class="btn btn-primary"
			href="<%=request.getContextPath()%>/facturacion?action=facturar&pid=<%=pedido.getId()%>">Facturar Pedido</a>
		<%
			}
		%>
	</div>
